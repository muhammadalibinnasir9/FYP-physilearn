...
from .views import (
    ...
    patch_parent_students_view,
    teacher_sections_view,
    admin_sections_list_view,
    admin_teacher_sections_view,
    admin_teacher_sections_update_view,
    ...
    generate_student_report_view, my_children_view
)
...
urlpatterns = [
    ...
    path('admin/create-user/', create_user_view, name='admin_create_user'),
    path('admin/sections/', admin_sections_list_view, name='admin_sections_list'),
    path('admin/teachers/', create_teacher_and_assign_sections_view, name='admin_create_teacher_assign_sections'),
    path('admin/teachers/<int:teacher_id>/sections/', admin_teacher_sections_view, name='admin_teacher_sections'),
    path('admin/teachers/<int:teacher_id>/sections/update/', admin_teacher_sections_update_view, name='admin_teacher_sections_update'),
    path('admin/parents/', create_parent_and_link_students_view, name='admin_create_parent_link_students'),
    path('admin/parents/<int:parent_id>/relink-students/', patch_parent_students_view, name='admin_patch_parent_students'),
