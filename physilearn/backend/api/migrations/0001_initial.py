    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(limit_choices_to={'role': 'TEACHER'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='students', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='HealthRecord',
            fields=[
                ...
                ('_bmi', models.TextField(blank=True, db_column='bmi', help_text='Encrypted BMI', null=True)),
                ('fitness_status', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='health_record', to='api.student')),
            ],
        ),
        migrations.CreateModel(
            name='FitnessPerformance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(auto_now_add=True)),
                ('metric_name', models.CharField(help_text='e.g., Endurance, Strength, Flexibility', max_length=100)),
                ('score', models.FloatField()),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performances', to='api.student')),
            ],
        ),
    ]
